...
public class PasswordInputEdt extends android.support.v7.widget.AppCompatEditText {
    ...
    private onInputOverListenerss onInputOverListeners;
    public void setOnInputOverListener(onInputOverListener onInputOverListener) {
        this.onInputOverListener = onInputOverListener;
    }
    public void setOnInputOverListener(onInputOverListenerss onInputOverListeners) {
        this.onInputOverListeners = onInputOverListeners;
    }
    ...
    protected void onTextChanged(CharSequence text, int start, int lengthBefore, int lengthAfter) {
        ...
        if (this.text.length() < numLength) {
            ...
            if (this.text.length() == 6) {
                if (onInputOverListeners != null) {
                    onInputOverListeners.onInputOver(this.text);
                    this.text = "";
                }
            }
        }
    ...
    public interface onInputOverListenerss {
        void onInputOver(String text);
    }
    ...
    public void closeText(){
        if (onInputOverListener != null)
            onInputOverListener.onInputOver("");
        this.text ="";
    }
}
